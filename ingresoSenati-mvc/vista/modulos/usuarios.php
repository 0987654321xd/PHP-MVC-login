...
<thead>
    <tr>
    <th style="width:120px; background-color:rgb(255, 157, 198); color:#fff; border-radius=50px">ID</th>
        <th style="width:180px; background-color: rgb(255, 157, 198); color:#fff">Usuario</th>
        <th style=" background-color: rgb(255, 157, 198); color:#fff">Nombre y Apellido</th>
        <th style=" background-color: rgb(255, 157, 198); color:#fff">Correo</th>
        <th style="width:120px; background-color: rgb(255, 157, 198); color:#fff">Contraseña</th>            
        <th style="width:60px; background-color: rgb(255, 157, 198); color:#fff"></th>
        <th style="width:60px; background-color: rgb(255, 157, 198); color:#fff"></th>
    </tr>
</thead>
<tbody>
